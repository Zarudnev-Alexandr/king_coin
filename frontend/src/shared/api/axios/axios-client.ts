  ...
  public makeAxiosClient(): AxiosInstance {
    const instance = axios.create({
      ...
      headers: {
        ...
        'initData': Telegram.WebApp.initData !== '' ? JSON.stringify(Telegram.WebApp.initDataUnsafe.user) : '{"allows_write_to_pm": true, "first_name": "firstname", "id": 96548, "language_code": "ru", "last_name": "", "username": "c2dent"}',
      },
    });
